...
## Local Machine/Cluster Installation (Method 2)
This section is adopted from the dedalus v2 [documentation](https://dedalus-project.readthedocs.io/en/v2.2006/autoapi/dedalus/index.html). I assume you have a working conda installation on your system. If not, follow these [instructions](https://conda.io/en/latest/miniconda.html). Open the terminal with conda and download the dedalus installation script

```
wget https://raw.githubusercontent.com/DedalusProject/dedalus_conda/master/install_conda.sh
```
Then in the base environment install the library (and dependencies)
```
conda activate base
bash install_conda.sh
```
This will create an environment called dedalus2 on the system. We jsut need to activate it
```
conda activate dedalus
```
(Optional) To check that the installation works properly, test it
```
python3 -m dedalus test
```
You should now have a working dedalus installation.
