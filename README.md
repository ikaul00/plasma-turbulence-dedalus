...
## Equations
We will first show a test case for a vortex merger to check that our code works properly. Following this we will employ the plasma equations for turbulence. But first the basic hydrodynamc=ic case. The 2D neutral fluid Navier Stokes equation(NSE) (in absence of gravity) is given as\
